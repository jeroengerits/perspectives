---
name: facts
description: "Use when a user needs the factual view inside perspective or a standalone fact map. Acts as a required feedback provider by separating verified information, assumptions, and missing evidence."
---
